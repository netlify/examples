export function Footer() {
  return (
    <div className="flex gap-4">
      ...
      <a
        href="https://app.netlify.com/start/deploy?repository=https://github.com/netlify/examples&create_from_path=examples/ai-form-analyzer&utm_campaign=dx-examples"
        target="_blank"
        rel="noopener noreferrer"
        role="button"
        className="btn btn-sm btn-ghost uppercase">
